      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            and share content (like posts, events, and images) within them. All
            content is user-generated, and we are not responsible for anything
            shared within your families. You are responsible for ensuring that
            your content complies with any applicable laws.
          </p>
          ...
          <p>
            ...
            strive to improve the site, but we cannot guarantee that everything
            will work perfectly or that your data will always be safe or
            available. Use the site at your own risk.
          </p>
